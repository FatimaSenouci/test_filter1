...
%
%      CANCER('Property','Value',...) creates a new CANCER using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to cancer_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      CANCER('CALLBACK') and CANCER('CALLBACK',hObject,...) call the
%      local function named CALLBACK in CANCER.M with the given input
%      arguments.
%
...
% Last Modified by GUIDE v2.5 20-Sep-2021 02:10:32
